...
class OSCNet(nn.Module):
    ...
    ## First using non-K version to initialize M and X, refer to Sec 1.2 in SM
        ...
        input_ini = torch.cat((XLI, P00), dim=1) # [16, 33, 64, 64]
...
class Mnet(nn.Module):
    ...
    def make_resblock(self, num_res):
        ...
        for i in range(num_res):
            layers.append(nn.Sequential(nn.Conv2d(self.channels, self.channels, kernel_size=5, stride=1, padding=2, dilation=1),
