...
parser.add_argument('--N', type=int, default=8, help='the number of feature maps')
...
parser.add_argument('--lamda', type=float, default=1e-6, help='loss weights')
